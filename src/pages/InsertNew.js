...
const InsertNew = ({snackBarFunc, update, setSelectedPage}) => {
  ...
  return (
    <Container style={{ marginTop: 80 }}>
      <Typography variant="h5" style={{fontWeight:'bold'}}>INSERISCI {percentualePrimaNecessita} - {percentualeSvago} - {percentualeRisparmi} ({DateUtils.getDateMonthYear(new Date())})</Typography>
